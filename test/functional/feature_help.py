...
"""Verify that starting ubiquitium with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ubiquitium with -h for help text")
        ...
        self.log.info("Start ubiquitium with -version for version information")
        ...
        self.log.info("Start ubiquitiumd with -fakearg to make sure it does not start")
