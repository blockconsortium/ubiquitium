...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ubiquitium-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ubiquitium-tx [options] <hex-tx> [commands]  Update hex-encoded ubiquitium transaction\n" +
            "or:     ubiquitium-tx [options] -create [commands]   Create hex-encoded ubiquitium transaction\n" +
            "\n";
