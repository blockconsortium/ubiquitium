 ...
 */
static const char* BITCOIN_PID_FILENAME = "ubiquitiumd.pid";
...
void Shutdown(InitInterfaces& interfaces)
{
    ...
    RenameThread("ubiquitium-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Ubiquitium-Blockchain/ubiquitium>";
    const std::string URL_WEBSITE = "<https://ubiquitium.com>";
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("ubiquitium-loadblk");
...
bool AppInitMain(InitInterfaces& interfaces)
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if ubiquitium is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if ubiquitium is started while in a temporary directory.\n",
