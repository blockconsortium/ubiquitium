...
{
    const char* pszTimestamp = "The UBIQUE project started in 2021.";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0xe585b4ae9b62f5c9cb5ceaf8c758c761d6a49fe0b9a2d482773dd2e9bb36cd7f");
        consensus.BIP65Height = 0;
        consensus.BIP66Height = 0;
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); 
        consensus.nPowTargetTimespan = 3.5 * 60;
        consensus.nPowTargetSpacing = 0.35 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 30; // 75% of 40
        consensus.nMinerConfirmationWindow = 160; // nPowTargetTimespan / nPowTargetSpacing * 4
        ...
        consensus.nMinimumChainWork = uint256S("0x02e60cba1fa2b651d3c9ee8cb90e2675a34283bc637569b95beae718be138a60");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x98a98f72724b339cb867aa09d2b55a4e9c09e5075b7477f9eccb724c22f529ba");
         ...
         */
        pchMessageStart[0] = 0x44; // U
        pchMessageStart[1] = 0x19; // B
        pchMessageStart[2] = 0x66; // I
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xe585b4ae9b62f5c9cb5ceaf8c758c761d6a49fe0b9a2d482773dd2e9bb36cd7f"));
        assert(genesis.hashMerkleRoot == uint256S("0x1a6d1dcc1fae3f7351e1c038c44b5690bf7ef4edcf48d12e44db7672a9af3c6b"));
        ...
        checkpointData = {
            {
                ...
                {  24700, uint256S("0x98a98f72724b339cb867aa09d2b55a4e9c09e5075b7477f9eccb724c22f529ba")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.BIP66Height = 0;
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 200 * 60;
        consensus.nPowTargetSpacing = 0.35 * 60;
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1610666666, 2, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x35b310a41788c6afb63c935dceafd5e9dff1cc75e729779c36e8b274a35b9118"));
        assert(genesis.hashMerkleRoot == uint256S("0x1a6d1dcc1fae3f7351e1c038c44b5690bf7ef4edcf48d12e44db7672a9af3c6b"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x35b310a41788c6afb63c935dceafd5e9dff1cc75e729779c36e8b274a35b9118")},
            }
        };
