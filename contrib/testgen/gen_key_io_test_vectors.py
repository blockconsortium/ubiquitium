...
bech32_templates = [
  ...
  ('uqb',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('uqb',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('uqb',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tuqb',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tuqb',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tuqb',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('ruqb',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('ruqb',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('ruqb', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tuqb',  17, 32, False, False, False),
  ('ruqb',  3,  1, False, False, False),
  ('uqb',   15, 41, False, False, False),
  ('tuqb',  0, 16, False, False, False),
  ('ruqb',  0, 32, True,  False, False),
  ('uqb',   0, 16, True,  False, False),
  ('tuqb',  0, 32, False, True,  False),
  ('ruqb',  0, 20, False, False, True)
]
